...
$pdf text "pdf4tcl 0.9.4.5: CID Font Unicode Demo" -x 50 -y 780

# Trennlinie
$pdf setFillColor 0.5 0.5 0.5
$pdf rectangle 50 770 495 1 -filled 1
...
foreach {label text} {
    ...
    $pdf text $label -x 50 -y $y
    $pdf setFont 13 cidSans
    $pdf text $text -x 200 -y $y
    incr y -28
}

...
# ---------------------------------------------------------------------------
# What catPdf refuses to read (0.9.4.48)
#
# PDF/A-2 and -3 require a cross-reference stream, which this reader does
# not handle. PDF/A-1 forbids the stream, so 1b merges.
# ---------------------------------------------------------------------------

...
lappend ::dbInfo {Tcl 9.0.2 unix, Tk 9.0.2 x11}
...
tk::pkgconfig
tk::print
tk::print::cups::defaultprinter
tk::print::cups::getprinters
tk::print::cups::print
tk::ps
tk::ps::function
tk::ps::literal
...
set ::syntax(tk::print::cups::defaultprinter) 0
set ::syntax(tk::print::cups::getprinters) 0
set ::syntax(tk::print::cups::print) {r 2}
...
set ::syntax(ttk::theme::alt::configureNotebookStyle) 1
set ::syntax(ttk::theme::clam::configureNotebookStyle) 1
...
set ::subCmd(_obj,ttk::treeview) {bbox cellselection cget children column configure delete detach detached drag drop exists focus heading identify index insert instate item move next parent prev see selection set state style tag xview yview}
...
set {::option(_obj,ttk::label cget)} {-background -foreground -font -borderwidth -relief -anchor -wraplength -takefocus -justify -text -textvariable -underline -width -image -compound -padding -state -cursor -style -class}
set {::option(_obj,ttk::label configure)} {-background -foreground -font -borderwidth -relief -anchor -wraplength -takefocus -justify -text -textvariable -underline -width -image -compound -padding -state -cursor -style -class}
...
set ::option(ttk::label) {-background -foreground -font -borderwidth -relief -anchor -wraplength -takefocus -justify -text -textvariable -underline -width -image -compound -padding -state -cursor -style -class}

...
set reporoot [pdf4tclRepoRoot $scriptDir]
...
set y [cs_row $pdf "dpi"      {unter 150 dpi -> ::pdf4tcl::warnings} $y $col 0]
set y [cs_row $pdf ""         {::pdf4tcl::imageDpiWarn setzt/schaltet ab} $y $col 0]
set y [cs_sep $pdf $y $col]
...
set y [cs_row $pdf "Umbruch"        {Leerraum; Bindestrich zwischen Woertern} $y $col 0]
set y [cs_row $pdf ""               {"-5" bleibt zusammen (0.9.4.60)} $y $col 0]
set y [cs_sep $pdf $y $col]
...
set y [cs_row $pdf ""              {ab 0.9.4.60 entbehrlich: Schrift wie} $y $col 1]
set y [cs_row $pdf ""              {die Familie benennen} $y $col 1]
...
set y [cs_col $pdf $y col $T3 $S3]
set y [cs_section $pdf "Schriftwahl ohne -fontmap (0.9.4.60)" $y $col]
set y [cs_code $pdf {pdf4tcl::createFontSpecCID Base Tahoma} $y $col]
set y [cs_code $pdf {.tp create text 20 30 -fontfamily Tahoma ...} $y $col]
set y [cs_code $pdf {$pdf canvas .tp   ;# kein -fontmap noetig} $y $col]
set y [cs_row $pdf "Schluessel"  {tko/tkpath: die Familie am Element} $y $col 0]
set y [cs_row $pdf ""            {tk::canvas: der Name aus -font,} $y $col 0]
set y [cs_row $pdf ""            {dann die von Tk aufgeloeste Familie} $y $col 0]
set y [cs_row $pdf "-fontmap"    {gewinnt weiterhin gegen die Suche} $y $col 0]
set y [cs_row $pdf "Standard 14" {ausgenommen -- deren Fettung bleibt} $y $col 0]
set y [cs_row $pdf "Leerzeichen" {im Namen ok, wird als #20 codiert} $y $col 0]
set y [cs_sep $pdf $y $col]

...
# ---------------------------------------------------------------------------
# 3. Was catPdf nicht lesen kann
# ---------------------------------------------------------------------------

puts "\n3. Grenzen der Eingabe"
puts [string repeat - 60]

# PDF/A-1 VERBIETET xref-Streams, PDF/A-2 und -3 VERLANGEN sie. Der Leser
# in catPdf kennt nur die klassische Tabelle.
foreach level {1b 2b} {
    foreach seite {a b} {
...
puts "\n  Betroffen sind damit alle Archivdokumente ab PDF/A-2b und jede"
puts "  ZUGFeRD-Rechnung. PDF/A-1b geht, weil die Norm dort xref-Streams"
puts "  verbietet."

...
# geht in die Event-Loop. Damit die Demo im Sammellauf ein definiertes Ende
# hat, endet sie wie unter tclsh.
#
# Hier stand frueher eine ausfuehrliche Begruendung, wish8.6 breche mit
# tko 0.4 beim Fensterschliessen ab. DIESE BEHAUPTUNG IST ZURUECKGEZOGEN:
# der Dreizeilen-Reproduzierer laeuft ohne Meldung durch. Solange kein
# Skript vorliegt, das den Fehler zeigt, gehoert die Behauptung nirgendwo
# hin -- weder hier noch in der Doku.
exit 0
